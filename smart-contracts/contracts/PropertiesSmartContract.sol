...
contract RealEstateDapp is ERC721URIStorage {
        ...
        returns (bool)
    {
        ...
        idToListedToken[_id].price = _listPrice;
        return true;
    }
    ...
    function getAllListings() public view returns (ListedToken[] memory) {
        uint256 listingsCount = _tokenIds.current();
        ListedToken[] memory tokens = new ListedToken[](listingsCount);
    ...
    function getMyInvestments() public view returns (ListedToken[] memory) {
